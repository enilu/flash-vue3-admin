  ...
  <div class="table-box">
    ...
    >
      ...
      <template #tableHeader="scope">
        <el-button v-auth="'loginLogClear'" type="danger" :icon="Delete" @click="handleClearLog(scope)">清除日志</el-button>
      </template>
    </ProTable>
...
import loginLogApi from "@/api/modules/operation/loginLog";
...
const getTableList = (params: any) => {
  ...
  return loginLogApi.getLogList(newParams);
};
...
const handleClearLog = async (row: any) => {
  console.log(row);
  await useHandleData(loginLogApi.clearLog, null, "清除所有日志");
  proTable.value?.clearSelection();
  proTable.value?.getTableList();
};
let selRecord = ref();
const showDetailDialog: boolean = false;
</script>
